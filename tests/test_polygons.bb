...
mousepoint.Point = CreatePoint(0,0)
...
While ta\loop
	...
	For pl.Polygon = Each Polygon 		
		DrawPolygon pl 
	Next 	
	Draw2DText "Number of polygon points : " + p\numpoints,5,5	
	Draw2DText "Polygon Point 0 : " + p\points[0]\x + " " + p\points[0]\y,5,25	
	If PointCollidedPolygon(mousepoint,p) Then Draw2DText "Collided",5,45
	Present()
Wend 	 