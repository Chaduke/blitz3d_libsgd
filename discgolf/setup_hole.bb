...
Function SetupHole(course,hole,b.BasicScene)	
	...
	SetMeshShadowsEnabled disc_mesh,True
	...
	SetMeshShadowsEnabled basket_mesh,True
		...
		Case 0 
			...
			Select hole
				...
				Case 2
					...
					basket_z = 120
					ob_padding = 2
					sky_texture = Load2DTexture("../engine/assets/textures/skybox/skyboxsun5deg.png",4,56)
					sky_roughness = 0.2
					light_angle = -5
					ambient# = 0.3
				...
				Case 3
					...
					basket_z = 240
					ob_padding = 5
					sky_texture = Load2DTexture("../engine/assets/textures/skybox/skyboxsun45deg.png",4,56)
					sky_roughness = 0.2
					light_angle = -45
					ambient# = 0.3
				...
				Case 4
					...
					basket_z = 120
					ob_padding = 2
					sky_texture = Load2DTexture("../engine/assets/textures/skybox/skyboxsun5deg2.png",4,56)
					sky_roughness = 0.2
					light_angle = -5
					ambient# = 0.1
				...
				Case 5
					...
					basket_z = 120
					ob_padding = 2
					sky_texture = Load2DTexture("sgd://envmaps/nightsky-cube.png",4,56)
					sky_roughness = 0
					light_angle = -65
					ambient# = 0.1
				...
				Case 6
					...
					basket_z = 120
					ob_padding = 2
					sky_texture = Load2DTexture("sgd://envmaps/grimmnight-cube.jpg",4,56)
					sky_roughness = 0.0
					light_angle = -60
					ambient# = 0.1
				...
				Case 7
					...
					basket_z = 120
					ob_padding = 2
					sky_texture = Load2DTexture("sgd://envmaps/stormy-cube.jpg",4,56)
					sky_roughness = 0.2
					light_angle = -5
					ambient# = 0.1
				...
				Case 8
					...
					basket_z = 250
					ob_padding = 2
					sky_texture = Load2DTexture("sgd://envmaps/sunnysky-cube.png",4,56)
					sky_roughness = 0.2
					light_angle = -15
					ambient# = 0.3
					b\trn\material_path = "../engine/assets/materials/Ground075_1K-JPG"				
