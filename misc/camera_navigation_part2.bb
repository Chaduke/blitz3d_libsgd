; camera_navigation_part2.bb
; by Chaduke

; this demonstrates how to create 
; a 3rd person camera rig 
; that is used in many games
; most notably MMOs and the like
; you can also use the mousewheel to 
; zoom all the way in and it becomes
; a first person camera
; I also added in procedural terrain
; as a bonus

Include "platformer/terrain.bb"

; create window and scene
CreateWindow(1920,1080,"3rd Person Camera Demo",256)
CreateScene()
