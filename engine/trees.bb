...
Function GenerateTrees(t.Terrain,numtrees,plus_fence = False) 
	...
	SetMeshShadowsEnabled treeMeshes(0),True
	treeMeshes(1) = LoadMesh("../engine/assets/models/trees/palm_tree2.glb")
	SetMeshShadowsEnabled treeMeshes(1),True
	treeMeshes(2) = LoadMesh("../engine/assets/models/trees/palm_tree4.glb")
	SetMeshShadowsEnabled treeMeshes(2),True	
