...
Function GenerateTrees(t.Terrain,numtrees,plus_fence = False) 
	...
	treeMeshes(0) = LoadMesh("../engine/assets/models/trees/tree1.glb")
	SetMeshShadowCastingEnabled treeMeshes(0),True
	treeMeshes(1) = LoadMesh("../engine/assets/models/trees/fall_tree.glb")
	SetMeshShadowCastingEnabled treeMeshes(1),True
	treeMeshes(2) = LoadMesh("../engine/assets/models/trees/birch_tree1.glb")
	SetMeshShadowCastingEnabled treeMeshes(2),True	
	; randomly distribute trees on the terrain
	For i=0 To numtrees			
		tx# = Rand(2,tw-2)
		tz# = Rand(2,td-2)	
		ty# = GetTerrainHeight(tx,tz,t) - 0.1		
		rs# = Rnd(2) + 0.5		
